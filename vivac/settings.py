...
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    'www.esportsvivac.com',
    'esportsvivac.com',  # Include this for non-www access as well
]
...
NACEX_USER = os.getenv('NACEX_USER')
NACEX_PASSWORD = os.getenv('NACEX_PASSWORD')
...
STRIPE_PAYMENT_METHOD = 'pmc_1NwVxXEUHJ3WTNbaat4t1kxi'
#APPEND_SLASH = False
# Database
